              ...
              {team.map((member) => (
                <div key={member.name} className="flex items-center gap-3">
                  <div
                    ...
                    style={{ background: "linear-gradient(135deg, hsl(183 100% 35%), hsl(265 70% 50%))", color: "white" }}
                  >
                    {member.initials}
                  </div>
                  <div>
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-4">
            <a
              ...
              className="glass rounded-lg p-2 hover:glow-border transition-all duration-200 group"
              aria-label="GitHub"
            >
              <svg className="w-5 h-5 text-muted-foreground group-hover:text-neon-cyan transition-colors" fill="currentColor" viewBox="0 0 24 24">
